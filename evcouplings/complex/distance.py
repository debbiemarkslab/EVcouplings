...
UNIPROT_AC_REGEX = ["^Uni\w+\_(\w+).*/",  #example: >UniRef100_H6SNJ6/11-331
                    "^\w+\|(\w+)\|\w+\/", #example: >tr|Q1NYN0|Q1NYN0_9FLAO
                    "^(\w+).*/.*$",       #example: >NQO8_THET8/1-365
                    "^\w+\|\w+\|(\w+)",   #example: >Q60019|NQO8_THET8/1-365]
                    ]
UNIPROT_EMBL_MAPPING_FILE = "/groups/marks/databases/complexes/idmapping/idmapping_uniprot_embl_2017_02.txt"
EMBL_CDS_DATABASE = "/groups/marks/databases/complexes/ena/2017_02/cds_pro.txt"


def retrieve_sequence_ids(fileobj,regex=UNIPROT_AC_REGEX):
    """
    ...
    regex : list of regular expression objects generated by re.compile
        default: list of objects to extract uniprot ACs 
