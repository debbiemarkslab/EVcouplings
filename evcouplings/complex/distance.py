...
def find_possible_partners(gene_location_table_1, gene_location_table_2,
    ...
    gene_location_table_2: pd.DataFrame
        ...
        protein, generated by extract_embl_annotation
    id_to_header_1 : dict of {str: str}
        Dictionary that points the Uniprot AC to the full
        header in the first alignment
    id_to_header_2 : dict of {str: str}
        Dictionary that points the Uniprot AC to the full
        header in the second alignment
