...
def complex(**kwargs):
    ...
    # If the users selected the existing alignment protocol
    # they must also supply an input annotation file
    # this overwrites the annotation file generated by the existing protocol
